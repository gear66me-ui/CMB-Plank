...
source = source.replace('# CMB-0040C_INFRASTRUCTURE.py', '# CMB-0042_INFRASTRUCTURE.py')
source = source.replace("VERSION = 'CMB-0040C'", "VERSION = 'CMB-0042'")
...
function invokeFind(v){
  try{
    if(window.google &&
      ...
      status(
        "<b>⏳ Searching galaxy catalogs...</b><br>Please wait...",
        "#ffd54f"
      );
