...
source = source.replace('# CMB-0040C_INFRASTRUCTURE.py', '# CMB-0040G_INFRASTRUCTURE.py')
source = source.replace("VERSION = 'CMB-0040C'", "VERSION = 'CMB-0040G'")
...
if n != 1:
    raise RuntimeError(f'CMB-0040G failed to preserve/patch 40C viewer block. Replacement count: {n}')

exec(compile(source2, 'CMB-0040G_INFRASTRUCTURE.py', 'exec'))
