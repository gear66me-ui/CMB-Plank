...
source = source.replace('# CMB-0040C_INFRASTRUCTURE.py', '# CMB-0044_INFRASTRUCTURE.py')
source = source.replace("VERSION = 'CMB-0040C'", "VERSION = 'CMB-0044'")
...
(function(){
  ...
  function invokeFind(v){ try { if(window.google && google.colab && google.colab.kernel && google.colab.kernel.invokeFunction){ setTimeout(function(){

          google.colab.kernel.invokeFunction('cmb40r.findGalaxy', [v], {}); return true; } } catch(e) {} return false; }
