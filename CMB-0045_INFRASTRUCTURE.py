...
source = source.replace('# CMB-0040C_INFRASTRUCTURE.py', '# CMB-0045_INFRASTRUCTURE.py')
source = source.replace("VERSION = 'CMB-0040C'", "VERSION = 'CMB-0045'")
...
(function(){
  ...
  try{
    if(window.google &&
      ...
      status("<b>⏳ Searching galaxy catalogs...</b><br>Please wait...", "#ffd54f");
      setButton("WORKING...", "#ef6c00", "#ffffff");
