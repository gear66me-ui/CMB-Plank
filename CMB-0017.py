"""CMB-0017 — Robust Gaia widget for RA 03:13:00.22, Dec -20:01:35.7."""
from __future__ import annotations
import urllib.request

SOURCE_URL = "https://raw.githubusercontent.com/gear66me-ui/CMB-Plank/main/CMB-0012.py"
req = urllib.request.Request(SOURCE_URL, headers={"User-Agent": "Mozilla/5.0 CMB-Gaia-Widget/17.0"})
with urllib.request.urlopen(req, timeout=60) as r:
    source = r.read().decode("utf-8")

# Coordinate update from the known CMB-0012 base.
replacements = [
    ('VERSION = "CMB-0012"', 'VERSION = "CMB-0017"'),
    ...
    ('Mozilla/5.0 CMB-Gaia-Widget/12.0', 'Mozilla/5.0 CMB-Gaia-Widget/17.0'),
]
...
# Remove the large multi-source catalogue dump.
...
# Replace pandas Styler display with guaranteed HTML.
...
namespace = {"__name__": "__main__", "__file__": "CMB-0017.py"}
exec(compile(source, "CMB-0017.py", "exec"), namespace, namespace)
